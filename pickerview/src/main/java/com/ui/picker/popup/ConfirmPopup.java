...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected final View makeContentView() {
        ...
        if (topLineVisible) {
            ...
            int height = Utils.toPx(activity, topLineHeight);
    ...
    protected View makeHeaderView() {
        ...
        int height = Utils.toPx(activity, topHeight);
        ...
        int padding = Utils.toPx(activity, topPadding);
        ...
        if (null == titleView) {
            ...
            int margin = Utils.toPx(activity, topPadding);
