...
import com.ui.picker.util.Utils;
...
//        Log.v("Test","isUserScroll=" + isUserScroll + ", index=" + index + ", item=" + item);
    ...
    private static class ItemView extends LinearLayout {
        ...
        private void init(Context context) {
            ...
            int paddingTopBottom = Utils.toPx(context, ITEM_PADDING_TOP_BOTTOM);
            int paddingLeftRight = Utils.toPx(context, ITEM_PADDING_LEFT_RIGHT);
            setPadding(paddingLeftRight, paddingTopBottom, paddingLeftRight, paddingTopBottom);
            setGravity(Gravity.CENTER);
            int height = Utils.toPx(context, ITEM_HEIGHT);
            ...
            imageParams.rightMargin = Utils.toPx(context, ITEM_MARGIN);
